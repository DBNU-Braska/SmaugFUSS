...
void do_color( CHAR_DATA* ch, const char* argument )
{
   ...
   {
      buffer_printf( ch->desc, "%sBlack Text\r\n", ANSI_BLACK );
      buffer_printf( ch->desc, "%sDark Red Text\r\n", ANSI_DRED );
      buffer_printf( ch->desc, "%sDark Green Text\r\n", ANSI_DGREEN );
      buffer_printf( ch->desc, "%sOrange/Brown Text\r\n", ANSI_ORANGE );
      buffer_printf( ch->desc, "%sDark Blue Text\r\n", ANSI_DBLUE );
      buffer_printf( ch->desc, "%sPurple Text\r\n", ANSI_PURPLE );
      buffer_printf( ch->desc, "%sCyan Text\r\n", ANSI_CYAN );
      buffer_printf( ch->desc, "%sGrey Text\r\n", ANSI_GREY );
      buffer_printf( ch->desc, "%sDark Grey Text\r\n", ANSI_DGREY );
      buffer_printf( ch->desc, "%sRed Text\r\n", ANSI_RED );
      buffer_printf( ch->desc, "%sGreen Text\r\n", ANSI_GREEN );
      buffer_printf( ch->desc, "%sYellow Text\r\n", ANSI_YELLOW );
      buffer_printf( ch->desc, "%sBlue Text\r\n", ANSI_BLUE );
      buffer_printf( ch->desc, "%sPink Text\r\n", ANSI_PINK );
      buffer_printf( ch->desc, "%sLight Blue Text\r\n", ANSI_LBLUE );
      buffer_printf( ch->desc, "%sWhite Text\r\n", ANSI_WHITE );
      buffer_printf( ch->desc, "%sBlink Black Text\r\n", BLINK_BLACK );
      buffer_printf( ch->desc, "%sBlink Dark Red Text\r\n", BLINK_DRED );
      buffer_printf( ch->desc, "%sBlink Dark Green Text\r\n", BLINK_DGREEN );
      buffer_printf( ch->desc, "%sBlink Orange/Brown Text\r\n", BLINK_ORANGE );
      buffer_printf( ch->desc, "%sBlink Dark Blue Text\r\n", BLINK_DBLUE );
      buffer_printf( ch->desc, "%sBlink Purple Text\r\n", BLINK_PURPLE );
      buffer_printf( ch->desc, "%sBlink Cyan Text\r\n", BLINK_CYAN );
      buffer_printf( ch->desc, "%sBlink Grey Text\r\n", BLINK_GREY );
      buffer_printf( ch->desc, "%sBlink Dark Grey Text\r\n", BLINK_DGREY );
      buffer_printf( ch->desc, "%sBlink Red Text\r\n", BLINK_RED );
      buffer_printf( ch->desc, "%sBlink Green Text\r\n", BLINK_GREEN );
      buffer_printf( ch->desc, "%sBlink Yellow Text\r\n", BLINK_YELLOW );
      buffer_printf( ch->desc, "%sBlink Blue Text\r\n", BLINK_BLUE );
      buffer_printf( ch->desc, "%sBlink Pink Text\r\n", BLINK_PINK );
      buffer_printf( ch->desc, "%sBlink Light Blue Text\r\n", BLINK_LBLUE );
      buffer_printf( ch->desc, "%sBlink White Text\r\n", BLINK_WHITE );
      write_to_buffer( ch->desc, ANSI_RESET, 0 );

      buffer_printf( ch->desc, "%s%sWhite Text, Black Background\r\n", ANSI_WHITE, BACK_BLACK );
      buffer_printf( ch->desc, "%s%sBlack Text, Dark Red Background%s\r\n", ANSI_BLACK, BACK_DRED, ANSI_RESET );
      buffer_printf( ch->desc, "%s%sBlack Text, Dark Green Background\r\n", ANSI_BLACK, BACK_DGREEN );
      buffer_printf( ch->desc, "%s%sBlack Text, Orange/Brown Background\r\n", ANSI_BLACK, BACK_ORANGE );
      buffer_printf( ch->desc, "%s%sBlack Text, Dark Blue Background\r\n", ANSI_BLACK, BACK_DBLUE );
      buffer_printf( ch->desc, "%s%sBlack Text, Purple Background\r\n", ANSI_BLACK, BACK_PURPLE );
      buffer_printf( ch->desc, "%s%sBlack Text, Cyan Background\r\n", ANSI_BLACK, BACK_CYAN );
      buffer_printf( ch->desc, "%s%sBlack Text, Grey Background%s\r\n", ANSI_BLACK, BACK_GREY, ANSI_RESET );
      buffer_printf( ch->desc, "%s%sBlack Text, Dark Grey Background\r\n",  ANSI_BLACK, BACK_DGREY );
      buffer_printf( ch->desc, "%s%sBlack Text, Red Background\r\n", ANSI_BLACK, BACK_RED );
      buffer_printf( ch->desc, "%s%sBlack Text, Green Background\r\n", ANSI_BLACK, BACK_GREEN );
      buffer_printf( ch->desc, "%s%sBlack Text, Yellow Background\r\n", ANSI_BLACK, BACK_YELLOW );
      buffer_printf( ch->desc, "%s%sBlack Text, Blue Background\r\n", ANSI_BLACK, BACK_BLUE );
      buffer_printf( ch->desc, "%s%sBlack Text, Pink Background\r\n", ANSI_BLACK, BACK_PINK );
      buffer_printf( ch->desc, "%s%sBlack Text, Light Blue Background\r\n", ANSI_BLACK, BACK_LBLUE );
      buffer_printf( ch->desc, "%s%sBlack Text, White Background\r\n", ANSI_BLACK, BACK_WHITE );
      buffer_printf( ch->desc, "%s%sGrey Text, Italics%s\r\n", ANSI_GREY, ANSI_ITALIC, ANSI_RESET );
      buffer_printf( ch->desc, "%s%sStrikeout%s\r\n", ANSI_GREY, ANSI_STRIKEOUT, ANSI_RESET );
      buffer_printf( ch->desc, "%s%sUnderline\r\n", ANSI_GREY, ANSI_UNDERLINE );
      write_to_buffer( ch->desc, ANSI_RESET, 0 );
      return;
   }
