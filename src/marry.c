...
void do_rings ( CHAR_DATA *ch, const char *argument )
{
    char arg1[MAX_INPUT_LENGTH];
    char arg2[MAX_INPUT_LENGTH];
    CHAR_DATA *victim;
    ...
    switch ( victim2->sex )
    {
        case SEX_FEMALE:
        {
            ...
            switch( victim->sex )
            {
                case SEX_FEMALE:
                {
                    s.printf( buf, MAX_STRING_LENGTH, "This is the beautiful diamond ring given to you by your lovely\n\rwife %s at your wedding. It signifies your eternal love for eachother.\n\r",victim->name );
                    ring->description = str_dup( buf );
                    break;
                }
                case SEX_MALE:
                {
                    snprintf( buf, MAX_STRING_LENGTH, "This is the beautiful diamond ring given to you by your handsome\n\rhusband %s at your wedding. It signifies your eternal love for eachother.\n\r", victim->name );
                    ring->description = str_dup( buf );
                    break;
                }
                case SEX_NEUTRAL:
                default:
                {
                    snprintf( buf, MAX_STRING_LENGTH, "This is the beautiful diamond ring given to you by your\n\rspouse %s at your wedding. It signifies your eternal love for eachother.\n\r", victim->name );
                    ring->description = str_dup( buf );
                    break;
                }
            }
            ...
            snprintf( buf, MAX_STRING_LENGTH, "The inscription reads:\n\rTo my lovely wife, yours forever, %s\n\r", victim->name );
        ...
        default:
        {
            ...
            switch( victim->sex )
            {
                case SEX_FEMALE:
                {
                    snprintf( buf, MAX_STRING_LENGTH, "This is the ring given to you by your beautifull wife %s\n\rat your wedding. It signifies your eternal love for eachother.\n\r", victim->name );
                    ring->description = str_dup( buf );
                    break;
                }
                case SEX_MALE:
                {
                    snprintf( buf, MAX_STRING_LENGTH, "This is the ring given to you by your handsome husband %s\n\rat your wedding. It signifies your eternal love for eachother.\n\r", victim->name );
                    ring->description = str_dup( buf );
                    break;
                }
                case SEX_NEUTRAL:
                default:
                {
                    snprintf( buf, MAX_STRING_LENGTH, "This is the ring given to you by your spouse %s at\n\ryour wedding. It signifies your eternal love for eachother.\n\r", victim->name );
                    ring->description = str_dup( buf );
                    break;
                }
            }
